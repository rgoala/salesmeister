            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl">
                <div className="border-sidebar-border/70 dark:border-sidebar-border relative min-h-[100vh] flex-1 overflow-hidden rounded-xl border md:min-h-min">
                    <div className="relative flex h-full w-full flex-col justify-left p-3">
                        <div className="mt-4">
                            <Link href="/admin/clients/create" className="rounded bg-blue-500 px-4 py-2 text-white hover:bg-blue-600">
                                Add New Client
                            </Link>
                        </div>
                                    ...
                                    {clients.length === 0 ? (
                                        ...
                                        clients.map((client) => (
                                            <tr className='odd:bg-blue-100' key={client.id}>
                                                ...
                                                <td className="px-2 py-2 whitespace-nowrap text-sm text-gray-900">{client.contact}</td>
                                                <td className="px-2 py-2 whitespace-nowrap text-sm text-gray-900"></td>
